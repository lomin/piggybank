...
(deftest ^:unit document-database-is-only-on-consistent-on-document-level-test
  (is (= false (props/more-than-one-document-change-per-time-slot? spec/example-universe)))
  (is (= false
         (props/more-than-one-document-change-per-time-slot? (assoc spec/example-universe
                                                                    :history
                                                                    (list spec/example-universe)))))
  (is (= false
         (props/more-than-one-document-change-per-time-slot? (-> spec/example-universe
